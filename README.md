...
This project was developed as part of a Bachelor thesis and is published with permission.
Any commercial use is not permitted without prior discussion with the author.
